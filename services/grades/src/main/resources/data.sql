...
VALUES 
('1234567890', 'BES', 80.0, 7.0, 'CURSING', 'MORNING', '2023-01-15'::DATE),
('0987654321', 'ADS', 75.0, 8.0, 'CURSING', 'MORNING', '2023-02-20'::DATE);
...
VALUES 
('BES', 'CURSING', 60, ARRAY[7.0, 8.0], 2, 1, '2023-01-15'::DATE),
('ADS', 'CURSING', 45, ARRAY[7.0, 8.0], 1, 1, '2023-02-20'::DATE);
